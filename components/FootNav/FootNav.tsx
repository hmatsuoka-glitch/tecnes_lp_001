      ...
      <div className={`l-inner ${styles.footNavInner}`}>
        ...
        <div className={styles.cta}>
          ...
          <div className={styles.ctaBtns}>
            <a href="#apply" className={styles.btnEntry}>応募フォームへ</a>
            <a href="https://lmasters.aigrowthx.pro/r/cmqhi2or8000bqm1wwidx2is0" target="_blank" rel="noopener noreferrer" className={styles.btnLine} onClick={trackLineClick}>
